...
async def menuban():
    os.system('cls & title [PFN TEAM Security team and breaker] - Loading & mode 69,20')
...
async def guild():
    ...
    sys.stdout.write("\n PFN TEAM a Security team and breaker \n ")
    sys.stdout.write("Discord : https://discord.gg/fxQppPhbva \n ")
    guildid = int(input(''' 
 [?] Enter guild id: '''))
