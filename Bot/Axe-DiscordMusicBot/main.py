...
class Music(commands.Cog):
    ...
    async def _move(self, ctx: commands.Context, *, channel: discord.VoiceChannel = None):
        """Join Channel In Which You Are In.
        """
    ...
    async def _stop(self, ctx: commands.Context):
        ...
        if ctx.voice_state.is_playing:
            ...
            await ctx.send("> Song Has Been Stopped")
            await ctx.message.add_reaction('⏹')
    ...
    async def _loop(self, ctx: commands.Context):
        ...
        await ctx.send("> Song Has Been Looped\n Use This Command again to unloop it")
        await ctx.message.add_reaction('✅')
...
bot = commands.Bot(prefix, description='Axe Music Bot!')
